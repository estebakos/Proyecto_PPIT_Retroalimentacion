package co.edu.poli.ppi.utilities.wizard.layouts;
...
import co.edu.poli.ppi.utilities.wizard.WizardFragment;
import co.edu.poli.ppi.utilities.wizard.persistence.ContextManager;
...
public abstract class BasicWizardLayout extends WizardFragment implements View.OnClickListener {
    ...
    public void onWizardComplete() {
        ...
        ApplicationSession.setEvaluationStep(0);
        ApplicationSession.setEvaluationStepInstance(null);
        ApplicationSession.setEvaluationSteps(0);
        ApplicationSession.setReadyToGetNote(true);
        getActivity().finish();
...
//                ApplicationSession.setEvaluationStep(ApplicationSession.getEvaluationStep()+1);
//                ApplicationSession.getEvaluationStepInstance().sendCriteria(wizard);
            wizard.goNext();
        }
